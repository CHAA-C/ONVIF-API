...
var OnvifServicePtz = /** @class */ (function (_super) {
    ...
    OnvifServicePtz.prototype.getNodes = function () {
        ...
        return soap_1.requestCommand(this.oxaddr, 'GetNodes', soap);
    };
    ...
    OnvifServicePtz.prototype.getConfigurations = function () {
        ...
        var soap = this.createRequestSoap(soapBody);
        return soap_1.requestCommand(this.oxaddr, 'GetConfigurations', soap);
    };
    ...
    OnvifServicePtz.prototype.getStatus = function () {
        var soapBody = '<tptz:GetStatus />';
        var soap = this.createRequestSoap(soapBody);
